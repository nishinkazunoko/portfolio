      ...
      <li className={styles['profile__card01']}>
        ...
        <div className={styles['profile__back']}>
          ...
          <div className="career__text">
            ...
            単に見た目を再現するだけでなく、アクセシビリティを考慮したセマンティックなHTML構造や、検索順位上位化を見据えたSEO設計を徹底し、クライアントの認知度・集客拡大に大きく貢献。<br />
